    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .WithControlsExcluding("<PlayStation Controller>/leftStick/y")
                .WithControlsExcluding("<PlayStation Controller>/leftStick/x")
                .WithControlsExcluding("<Xbox Controller>/Left Stick/y")
                .WithControlsExcluding("<Xbox Controller>/leftStick/x")
                .WithControlsExcluding("<Gamepad>/leftStick/y")
                .WithControlsExcluding("<Gamepad>/leftStick/x")
                .WithControlsExcluding("<PlayStation Controller>/rightStick/y")
                .WithControlsExcluding("<PlayStation Controller>/rightStick/x")
                .WithControlsExcluding("<Xbox Controller>/right Stick/y")
                .WithControlsExcluding("<Xbox Controller>/rightStick/x")
